...
- **« À paraître »** (`#a-paraitre`, accueils FR + EN, entre Catalogue et Savoir-faire) : les projets en préparation, décrits **par type, sans nom** (choix du user le 24/09/2026 : les noms peuvent changer). Grand public : location immobilière, seconde main, enseignement, emploi ; professionnels : caisse restaurants/cafés, suivi de chantier, coopérative agricole. Quand un projet sort, il passe au Catalogue avec son nom et quitte cette liste.
